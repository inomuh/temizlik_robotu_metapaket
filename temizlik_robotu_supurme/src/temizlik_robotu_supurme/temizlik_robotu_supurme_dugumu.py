...
class TemizlikRobotuSupurme(object):
    ...
    def ana_fonksiyon(self):
        ...
        rospy.Subscriber('/mesafe_hesabi', MesafeBilgisi, self.mesafe_hesabi_callback_fonksiyonu)
        self.robot_hiz_yayini = rospy.Publisher('/cmd_vel', Twist, queue_size=10)
        self.engel_bilgi_servisi = rospy.Service('engel_bilgi', EngelBilgi, self.engel_bilgilendirme_servisi)
        self.bilgi_servisi = rospy.Service('bilgi_servisi', BilgiServisi, self.gorev_bilgilendirme_servisi)
    ...
    #   PARAMETRELER:
    #       ADI										TIPI			        AÇIKLAMASI
    #   istek                                       EngelBilgi              İstemciden gelen hareket emri değerini okur.
    #
    #   DÖNÜS:
    #       ADI				                        TIPI				    AÇIKLAMASI
    #   yanit                                       EngelBilgi              İstemciye gönderilen yanit değeridir.
    #
    #   GEREKLILIK:
    ...
    def engel_bilgilendirme_servisi(self, istek):
        ...
        return EngelBilgiResponse(yanit)
    ...
    #   PARAMETRELER:
    #       ADI										TIPI			        AÇIKLAMASI
    #   istek                                       BilgiServisi            İstemciden gelen istek değerini okur.
    #
    #   DÖNÜS:
    #       ADI				                        TIPI				    AÇIKLAMASI
    #   yanit                                       BilgiServisi            İstemciye gönderilen tamamlanan_gorev_yuzde_degeri
    #                                                                       yanit değeridir.
    #
    #   GEREKLILIK:
    ...
    def gorev_bilgilendirme_servisi(self, istek):
        ...
        return BilgiServisiResponse(yanit)
    ...
    #   PARAMETRELER:
    #       ADI										TIPI			        AÇIKLAMASI
    #   odom_mesaji                                 MesafeBilgisi           Topiğin değerinin okunması için gereken mesaj tipidir.  
    #
    #   DÖNÜS:
    #       ADI				                        TIPI				    AÇIKLAMASI
    #
